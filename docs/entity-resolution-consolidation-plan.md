...
```
pipelines/transforms/entity_resolution/61_clean_staging_views/
...
pipelines/transforms/entity_resolution/62_unified_entity_table/
  unified_entity_table.sql        MODIFY — add PB + HAR UNION ALL arms

pipelines/transforms/entity_resolution/63_match_edges/
